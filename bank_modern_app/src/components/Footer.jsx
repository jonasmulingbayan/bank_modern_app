...
const Footer = () => (
  ...
  <section className = {`${styles.flexCenter} ${styles.paddingY} flex-col`}>
    ...
    <div className = "w-full flex justify-between items-center md:flex-row flex-col mt-4 pt-6 border-t-[1px] border-t-[#3f3e45]">
    ...
    <ScrollToTop className = {`bg-blue-gradient font-poppins font-medium text-white pl-1 text-[13px] items-center justify-center align-center rounded-full hover:bg-[#ffc001]`} smooth color = "#fff"/>
